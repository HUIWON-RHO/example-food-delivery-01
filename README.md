...
1. 라이더가 해당 요리를 pick한 후, pick했다고 앱을 통해 통보한다.
1. 고객이 주문상태를 중간중간 조회한다.
1. 주문상태가 바뀔 때 마다 카톡으로 알림을 보낸다.
1. 고객이 요리를 배달 받으면 배송확인 버튼을 탭하여, 모든 거래가 완료된다.
### + 기능적 요구사항 추가 내용
1. 상점주는 메뉴를 추가할 수 있다
1. 모든 거래가 완료되면 고객은 리뷰를 작성할 수 있고, 고객이 메뉴를 선택할 때 리뷰를 참고할 수 있다.
...
## 1. Saga(Pub/Sub)
  ...
  - Pub/Sub
  ![image](https://user-images.githubusercontent.com/59330544/203248247-76a7ea5b-33b3-459c-99ae-ba3502677ca3.png)
## 2. CQRS
  ...
  ![image](https://user-images.githubusercontent.com/59330544/203249207-911493c2-463f-4840-9be4-12846eef53ff.png)
  ![image](https://user-images.githubusercontent.com/59330544/203249379-76dfa21b-1a8f-4ed5-a28a-c04bbc40ef03.png)
  ![image](https://user-images.githubusercontent.com/59330544/203249473-f9d8baf8-da1b-41b1-b868-61b006411957.png)
  ![image](https://user-images.githubusercontent.com/59330544/203249564-cdb0ec11-8fe4-4fda-a415-c107d15b05b9.png)

## 3. Compensation / Correlation
  - 주문 취소가 발생 : 'cancel' command를 http DELETE로 실행시키고 store의 Order를 삭제한다
  ![image](https://user-images.githubusercontent.com/59330544/203251782-1a34a951-c346-4de6-b55a-006bb8536919.png)
  ![image](https://user-images.githubusercontent.com/59330544/203253252-8bc7000c-efc8-4225-bbe1-d86274267727.png)
## 4. Request / Response
  ![image](https://user-images.githubusercontent.com/59330544/203253995-4f70a82b-f78d-4f66-97b0-0bfe8faef56c.png)
  ![image](https://user-images.githubusercontent.com/59330544/203254907-3e1be507-716d-40df-bc7c-53071aaa4edf.png)

  - 배달이 완료되면 '리뷰'작성을 하게 하고, 리뷰 작성이 완료되면 모든 거래가 완료된다.
  ![image](https://user-images.githubusercontent.com/59330544/203254195-e12140e0-2890-4898-bd87-e043ed6ae563.png)
## 5. Circuit Breaker
...
## Event Storming 결과
* MSAEz 로 모델링한 이벤트스토밍 결과:  https://labs.msaez.io/#/storming/cy8NXkhwCVN5OQRz7JZ24nIbovg1/ba883a8f190bf038bd9f10c1498dfacd
